...
fileName = "BinarySearchIterative.py"
...
body = "".join(bodyLines[1:])
if "binarySearch" in body:
    print("You have called the function within the body.")
    print("I.e. this function is recursive.")
    print("This file was meant to contain the iterative version")
    sys.exit(1)
